...
class ScheduleListController: UIViewController {
  ...
  private func update(oldEvent: Event, with newEvent: Event) {
    ...
    //retrieve object from documents dirctory.
    // append to out events array
  ...
  @IBAction func editButtonPressed(_ sender: UIBarButtonItem) {
    ...
    private func showCreateEventVC(_ event: Event? = nil){ // default prarameters
//        we need to use the story board to get an instance of the CreateEventController.
        // if we had multiple storyboards
//        let loginStoryboard = UIStoryboard(name: "login", bundle: nil)
        ...
        // let creatEC = CreateEventCntroller() - creates an empty view controller without any outlets, etc. will crash if you are expecting your outlets to work if they exsist on the story board.
        
       
        
        if  let event = event { // this means an event was passed into this function.
